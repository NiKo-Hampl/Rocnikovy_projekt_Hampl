# Dokumentace použitých knihoven v projektu

Tento dokument popisuje knihovny (Assets / obsah) použité v našem projektu skákací hry ve stylu *Only Up* v Unreal Engine 5.  
...
### 3. Man (mesh na postavu)
- **Typ:** Character / Mesh  
- **Popis:** Mesh lidské postavy použitelný jako hráč nebo NPC.  
- **Použití ve hře:** Hlavní hráčská postava.  
...
> **Poznámka:** Některé knihovny jsou zatím připraveny k použití, ale ještě nebyly implementovány do hry. Tento seznam se bude průběžně aktualizovat.
